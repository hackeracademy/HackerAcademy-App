module ContestsHelper
  ...
  def generate_contest_1_level0 len, num_words
  ...
  def verify_contest_1_level0 word_indices, puzzle
  ...
  def generate_contest_1_level1 len, num_words
    words = random_words num_words
  ...
  def verify_contest_1_level1 word_indices, puzzle_chars
  ...
  def generate_contest_1_level2 len, num_words
    words = random_words num_words
    text = Array.new(len, nil)
    text.map! {|x| Array.new(len, nil)}
  ...
  def verify_contest_1_level2 word_indices, puzzle_chars
    puzzle = puzzle_chars.split /\n/
    word_indices.each do |wsym, loc|
      word = wsym.to_s
      col, row = loc
